...
const copy = {
    ...
    bluefyTitle: 'Bluefy 蓝牙功能可用', bluefyBody: '可以连接设备进行升级，请在传输期间保持 Bluefy 位于前台。',
    supportedTitle: '浏览器蓝牙功能可用', supportedBody: '可以连接设备进行升级，传输期间请保持页面位于前台。',
...
function showPlatformNotice() {
  ...
  notice.classList.toggle('supported', supported);
  $('noticeIcon').setAttribute('href', supported ? '#i-check' : '#i-alert');
